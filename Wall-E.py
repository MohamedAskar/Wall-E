...
def drawBody():
    ...
    glColor3f(0.5846, 0.6571, 0.74)
    drawRect(0.425, 0.5, -0.425, 0.5, -0.425, 0.3, 0.425, 0.3)
    ...
    glColor3f(0.5086, 0.78, 0.2184)
    drawRect(0.17, 0.46, 0.07, 0.46, 0.07, 0.34, 0.17, 0.34)
    glColor3f(0.91, 0.7121, 0.1183)
    drawRect(0.39, 0.29, -0.39, 0.29, -0.39, -0.15, 0.39, -0.15, False)
    glColor3f(0.82, 0.6155, 0.0984)
    drawRect(-0.04, 0.29, -0.3, 0.29, -0.3, -0.04, -0.04, -0.04, False)
    glColor3f(1, 1, 1)
    drawLines(-0.408, -0.1, -0.408, -0.06)
    drawLines(-0.408, -0.04, -0.408, 0.425)
    ...
    glColor3f(0.51, 0.3213, 0.204)
    drawRect(0.04, 0.8, -0.04, 0.8, -0.04, 0.7, 0.04, 0.7)
    glColor3f(0.51, 0.3213, 0.204)
    drawRect(0.15, 0.82, -0.15, 0.82, -0.15, 0.72, 0.15, 0.72)
    glColor3f(0.51, 0.3213, 0.204)
    drawRect(0.15, 0.76, -0.15, 0.76, -0.15, 0.72, 0.15, 0.72)
    glColor3f(0.77,0.2433,0.2156)
    drawCircle(0.02,-0.15,0.35,0,2,False)
    glColor3f(0,0,0)
    drawDashLine(-0.17,0.46,0.02)
    drawDashLine(-0.17, 0.43, 0.02)
    drawDashLine(-0.17, 0.4, 0.02)
...
def drawGround():
    glColor3f(0.408, 0.494, 0.518)
    glLineWidth(4)
    drawLines(1,0,0.9,0)
    drawLines(0.85, 0, 0.8, 0)
    drawLines(0.75, 0, -0.75, 0)
    drawLines(-0.85, 0, -0.8, 0)
    drawLines(-1, 0, -0.9, 0)
    drawLines(-0.82,-0.08,-0.4,-0.08)
    drawLines(-0.36,-0.08,0.82,-0.08)
    drawLines(-0.7,-0.16,0.2,-0.16)
    drawLines(0.24,-0.16,0.68,-0.16)
...
def drawName():
    ...
    drawLines(0,0,0.1,0)
    drawLines(0,0,0,0.1)
    drawLines(0.05,0,0.05,0.1)
    drawLines(0.1,0,0.1,0.1)
    drawLines(0.15,-0.01,0.15,0.1)
    drawLines(0.15,0.09,0.2,0.09)
    drawLines(0.2,-0.01,0.2,0.1)
    drawLines(0.15,0.05,0.2,0.05)
    drawLines(0.24,0,0.3,0)
    drawLines(0.25,0,0.25,0.1)
    drawLines(0.32, 0, 0.39, 0)
    drawLines(0.33, 0, 0.33, 0.1)
    drawLines(0.4,0.05,0.44,0.05)
    glColor3f(0.77,0.2433,0.2156)
